...
{
    public class ApplicantDebtorListExportService : IApplicantDebtorListExportService
    {
        public async Task<byte[]> ExportToCsvAsync(IEnumerable<ApplicantDebtorListDto> data, string statusFilter = "all", string searchText = "")
        {
            ...
            csv.Context.RegisterClassMap<ApplicantDebtorListMap>();
        ...
        private IEnumerable<ApplicantDebtorListDto> FilterData(
            IEnumerable<ApplicantDebtorListDto> data,
            string statusFilter,
            string searchText)
        {
            var query = data;
        ...
        private string GetApplicantFullName(ApplicantDebtorListDto record)
        {
    ...
    public sealed class ApplicantDebtorListMap : ClassMap<ApplicantDebtorListDto>
    {
        public ApplicantDebtorListMap()
        {
            Map(m => m.Id).Name("ID");
