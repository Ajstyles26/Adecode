...
{
    public class RegisterModel4 : PageModel
    {
        ...
        private async Task<ApplicationUser> CreateUserAsync(InputModel4 currentUserModel)
        {
            try
            {
                ...
                user.CurrentUserType = ACUnified.Data.Enum.UserType.AdmissionOfficer;
